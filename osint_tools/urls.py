...
urlpatterns = [
    ...
    path('cases/<int:case_id>/link-session/', views.link_session_to_case, name='link_session_to_case'),
    path('cases/<int:case_id>/unlink-session/<int:session_id>/', views.unlink_session_from_case, name='unlink_session_from_case'),
    path('cases/<int:case_id>/available-sessions/', views.get_available_sessions, name='get_available_sessions'),
